        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttenderntId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attendee_Attendee_AttenderntId",
                        column: x => x.AttenderntId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Categories = table.Column<string>(maxLength: 255, nullable: true),
                    Speakers = table.Column<string>(maxLength: 255, nullable: true),
                    Sponsors = table.Column<string>(maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    For = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresentAddress = table.Column<string>(maxLength: 800, nullable: true),
                    PresentCity = table.Column<string>(maxLength: 100, nullable: true),
                    PresentState = table.Column<string>(maxLength: 100, nullable: true),
                    PresentPin = table.Column<string>(maxLength: 20, nullable: true),
                    PermanentAddress = table.Column<string>(maxLength: 800, nullable: true),
                    ...
                    PermanentPin = table.Column<string>(maxLength: 20, nullable: true),
